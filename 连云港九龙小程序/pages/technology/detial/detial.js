...
Page({
  ...
  `;
    ...
    var article = `<!DOCTYPE html >
     </form>--><div class="cl"></div>  </div><script type="text/javascript" src="/lib/js/bdtj.js"></script><p><strong>相关文章:</strong></p>  <p>·<a href="/qwjs/32/" target="_blank">【早泄】欧式NT阴茎敏感神经分离术，延长性生</a></p><p>·<a href="/qwjs/49/" target="_blank">【阳痿治疗】STR五环性功能康复术，让男人重</a></p><p>·<a href="/qwjs/41/" target="_blank">【包皮包茎】韩式纳米微创包皮整形术</a></p><p>·<a href="/qwjs/96/" target="_blank">前列腺炎  隧道扫描下靶向分型疗法</a></p><p>·<a href="/qwjs/72/" target="_blank">【龟头炎】CRS光导系统快速根除包皮龟头炎</a></p><p>·<a href="/qwjs/71/" target="_blank">【淋病】DHA联动基因康复术；阻断淋病复发</a></p>  </div><div class="cl"></div><div id="shadow"></div><img src="" alt=""/></div><script type="text/javascript" src="/lib/js/fd.js"></script>-->
